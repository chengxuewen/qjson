> [!IMPORTANT]
>
> This project is archived. QJson was originally created when Qt3 and Qt4 lacked robust JSON support.
>
> Since Qt5, JSON support is included in the native Qt library SDK, making this project obsolete.
